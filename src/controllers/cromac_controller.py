...
class CromacMAC:
    ...
    def forward(self, ep_batch, t, test_mode=False, train_mode=False, t_env=None):
        agent_inputs = self._build_inputs(ep_batch, t)
        state = ep_batch["state"][:, t]
        agent_outs, self.hidden_states, losses = self.agent(agent_inputs, state, self.hidden_states, test_mode=test_mode, train_mode=train_mode, actions=ep_batch['actions'][:, t], mask=ep_batch['filled'][:, t], t_env=t_env)
