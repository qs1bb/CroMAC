    ...
    def train(self, batch: EpisodeBatch, t_env: int, episode_num: int):
        ...
        for t in range(batch.max_seq_length):
            agent_outs,  returns_ = self.mac.forward(
                batch, t=t, test_mode=False, train_mode=True, t_env=t_env)
        ...
        if self.args.robust:
            for p in self.mac.agent.poe.message_encoder.parameters():
                p.data.clamp_(-self.args.weight_clamp, self.args.weight_clamp)
